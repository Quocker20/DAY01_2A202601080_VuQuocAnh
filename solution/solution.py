...
def compare_models(prompt: str) -> dict:
    ...
    return {
        ...
        "mini_time": mini_time,
        "gpt4o_cost": (len(gpt4o_answer.split()) / 0.75) / 1000 * PRICING_PER_1K_TOKENS.get(
            OPENAI_MODEL, PRICING_PER_1K_TOKENS["gpt-4o"])["output"]
    }
...
def streaming_chatbot() -> None:
    ...
    while True:
        ...
        # Keep only the last 4 turns (8 messages)
        history = history[-8:]
